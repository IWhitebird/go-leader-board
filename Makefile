...
wrk_stress:
	...
	@mkdir -p logs
	@parallel ::: \
		"wrk -t12 -c10000 -d15s -s ./scripts/wrk/score_post.lua http://localhost:80 > logs/score_post.txt" \
		"wrk -t12 -c13 -d15s -s ./scripts/wrk/get_top_leaders.lua http://localhost:80 > logs/get_top_leaders.txt" \
		"wrk -t12 -c13 -d15s -s ./scripts/wrk/get_user_rank.lua http://localhost:80 > logs/get_user_rank.txt"
